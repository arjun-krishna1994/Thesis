...
class CloudAgent():
    ...
    def processLaterResponse(self, response):
        ...
        import json 
        import datetime
        f = open('actuator_cloud_end_2.txt', 'a+')
        ...
        print "Processed Observe input from sensor 2"
...
client = CloudAgent(protocol, host='127.0.0.1', port=5684, uri='sensorReading2')
reactor.listenUDP(61658, protocol)
reactor.run()
