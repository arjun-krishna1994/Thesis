...
class SensorReadingResource(resource.Resource):
    """
    Example resource which supports GET and PUT methods. It sends large
    responses, which trigger blockwise transfer.
    """
...
#    root.add_resource(('.well-known', 'core'), CoreResource(root))
    ...
    root.add_resource(('sensor',), SensorDetailResource())
    root.add_resource(('reading',), SensorReadingResource())
...
if __name__ == "__main__":
    print("Running Actuator Server on port 5685.")
    main(port=5685)
